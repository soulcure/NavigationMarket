...
public class FileAsyncTaskDownload extends AsyncTask<String, Integer, String> {
	public static final String PARENT_PATH = "/.appMarket";
	...
	public DownLoadingListener getProgressListener(){
	...
	protected String doInBackground(String... params) {
		...
		try {
			...
			if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK
				...
				long percentile = fileSize/100; // 文件每下载1%的长度
				int count = 0;
				...
				while (flag && ((readedLength = inputStream.read(b)) != -1)) {
					...
					{
						count = (int) (startPosition / percentile);
	...
	public interface DownLoadingListener {
		...
		void downloadSuccess(String rate);

		void setbView(ButtonView detailView, ButtonView listView);
	}
