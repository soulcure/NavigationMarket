...
public class BestAppSwipeRefreshLayout extends SwipeRefreshLayout{
	...
	public BestAppSwipeRefreshLayout(Context context,String url) {
		super(context);
		mContext=context;
		mUrl=url;
		...
		recommendListAdapter = new RecommendListAdapter(new ArrayList<GameItem>(),(Activity)context);
	...
	private class HttpAsyncTask extends AsyncTask<String, GameItem, Void> {
		...
		protected void onPreExecute() {  
			BestAppSwipeRefreshLayout.this.setRefreshing(true);
		}  
		...
		protected void onProgressUpdate(GameItem... progress) {
			...
			recommendListAdapter.addItem(item);
		}


		@Override  
		protected void onPostExecute(Void v) { 
			BestAppSwipeRefreshLayout.this.setRefreshing(false);
		}  
	}
